...
local text = '♨️ثلاث اعضاء النشطين في المجموعة\n\n1⃣ '..maxname[1]..'〖'..maxuser[1]..'〗\n\n📨مجموع عدد المشاركات: '..maxtex[1] + maxph[1] + maxst[1] + maxoth[1]..'\n👾الملصقات: '..maxst[1]..'\n📷الصور: '..maxph[1]..'\n📃 الرسائل: '..maxtex[1]..'\n📦 الملف: '..maxoth[1]
if maxid[2] then
	if not maxid[3] then
text = text..'\n\n 2⃣ '..maxname[2]..' 〖'..maxuser[2]..'〗\n\n📨مجموع عدد المشاركات: '..maxtex[2] + maxph[2] + maxst[2] + maxoth[2]..'\n👾الملصقات: '..maxst[2]..'\n📷الصور: '..maxph[2]..'\n📃 الرسائل: '..maxtex[2]..'\n📦 الملف: '..maxoth[2]
else
text = text..'\n\n 2⃣ '..maxname[2]..' 〖'..maxuser[2]..'〗\n\n📨مجموع عدد المشاركات: '..maxtex[2] + maxph[2] + maxst[2] + maxoth[2]..'\n👾الملصقات: '..maxst[2]..'\n📷الصور: '..maxph[2]..'\n📃 الرسائل: '..maxtex[2]..'\n📦 الملف: '..maxoth[2]..'\n\n 3⃣ '..maxname[3]..' 〖'..maxuser[3]..'〗\n\n📨مجموع عدد المشاركات: '..maxtex[3] + maxph[3] + maxst[3] + maxoth[3]..'\n👾الملصقات: '..maxst[3]..'\n📷الصور: '..maxph[3]..'\n📃 الرسائل: '..maxtex[3]..'\n📦 الملف: '..maxoth[3]
end
end
